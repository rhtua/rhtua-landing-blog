        ...
        <div className='container flex flex-col items-center gap-16'>
          <div className='text-center'>
            ...
            <p className='mx-auto max-w-2xl text-muted-foreground md:text-lg'>
              Aqui eu documento conhecimentos relevantes que vou acumulando ao
              longo do tempo, crio publicações que gostaria de ter encontrado
              quando estava aprendendo, e compartilho experiências que considero
              valiosas. Espero que você encontre algo útil aqui!
            </p>
          </div>
