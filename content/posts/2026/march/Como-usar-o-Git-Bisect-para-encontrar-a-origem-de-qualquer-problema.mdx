...
excerpt: |
  Como utilizar a ferramenta de busca binária nativa do Git para identificar a origem de commits
...
Após compilar e testar novamente, basta informar o resultado ao Git. Se a versão atual funcionar corretamente: 
