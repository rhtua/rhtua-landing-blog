...
const aboutTextPortuguese: AboutTextStructure = {
  ...
  projectsList: {
    agilePoll: {
      ...
      technologies: 'React | Typescript | Firebase | ChakraUI',
    ...
    portifolio_v1: {
      ...
      technologies: 'Gatsby | Javascript | TailwindCSS | GraphQL',
    ...
    devCrud: {
      ...
      technologies: 'Figma | Docker | NodeJS | ReactJS',
    ...
    vendaTurbinada: {
      ...
      technologies: 'React | RemixJS | Typescript | ChakraUI',
    ...
    letMeAsk: {
      ...
      technologies: 'Firebase  | Jest | SASS | ReactJS',
    ...
    notado: {
      ...
      technologies: 'Visual Studio | Entity | .Net MVC',
...
const aboutTextEnglish: AboutTextStructure = {
  ...
  workExperiences: {
    gazin: {
      period: "2021 - Today",
      timespan: `${gazinWorkPeriod.years} years ${gazinWorkPeriod.months ? "and " + gazinWorkPeriod.months : ""
